...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'dmzx.mchat.admin.controller' => 'getDmzx_Mchat_Admin_ControllerService',
            'dmzx.mchat.core' => 'getDmzx_Mchat_CoreService',
            'dmzx.mchat.functions_mchat' => 'getDmzx_Mchat_FunctionsMchatService',
            'dmzx.mchat.listener' => 'getDmzx_Mchat_ListenerService',
            'dmzx.mchat.main.controller' => 'getDmzx_Mchat_Main_ControllerService',
            'dmzx.prettytopic.listener' => 'getDmzx_Prettytopic_ListenerService',
            ...
            'sitesplat.flatbootsminicms.listener' => 'getSitesplat_Flatbootsminicms_ListenerService',
            'sitesplat.fltl.admin_listener' => 'getSitesplat_Fltl_AdminListenerService',
            'sitesplat.fltl.listener' => 'getSitesplat_Fltl_ListenerService',
            'sitesplat.fltl.main' => 'getSitesplat_Fltl_MainService',
            'sitesplat.service' => 'getSitesplat_ServiceService',
            'sitesplat.snappy.listener' => 'getSitesplat_Snappy_ListenerService',
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'sanctuar_phpb337', '4]wS[Pp23r', 'sanctuar_phpb337', '', false, false);
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('dmzx.mchat.listener', 'dmzx\\mchat\\event\\listener');
        $instance->addSubscriberService('dmzx.prettytopic.listener', 'dmzx\\prettytopic\\event\\listener');
        ...
        $instance->addSubscriberService('sitesplat.flatbootsminicms.listener', 'sitesplat\\flatbootsminicms\\event\\listener');
        $instance->addSubscriberService('sitesplat.fltl.listener', 'sitesplat\\fltl\\event\\listener');
        $instance->addSubscriberService('sitesplat.fltl.admin_listener', 'sitesplat\\fltl\\event\\admin_listener');
        $instance->addSubscriberService('sitesplat.snappy.listener', 'sitesplat\\snappy\\event\\listener');
    ...
    /**
     * Gets the 'dmzx.mchat.admin.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \dmzx\mchat\controller\admin_controller A dmzx\mchat\controller\admin_controller instance.
     */
    protected function getDmzx_Mchat_Admin_ControllerService()
    {
        return $this->services['dmzx.mchat.admin.controller'] = new \dmzx\mchat\controller\admin_controller($this->get('config'), $this->get('template'), $this->get('log'), $this->get('user'), $this->get('dbal.conn'), $this->get('cache'), $this->get('request'), 'phpbb_mchat', './', 'php');
    }

    /**
     * Gets the 'dmzx.mchat.core' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \dmzx\mchat\core\mchat A dmzx\mchat\core\mchat instance.
     */
    protected function getDmzx_Mchat_CoreService()
    {
        return $this->services['dmzx.mchat.core'] = new \dmzx\mchat\core\mchat($this->get('dmzx.mchat.functions_mchat'), $this->get('config'), $this->get('controller.helper'), $this->get('template'), $this->get('user'), $this->get('auth'), $this->get('pagination'), $this->get('request'), $this->get('dispatcher'), './', 'php');
    }

    /**
     * Gets the 'dmzx.mchat.functions_mchat' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \dmzx\mchat\core\functions_mchat A dmzx\mchat\core\functions_mchat instance.
     */
    protected function getDmzx_Mchat_FunctionsMchatService()
    {
        return $this->services['dmzx.mchat.functions_mchat'] = new \dmzx\mchat\core\functions_mchat($this->get('config'), $this->get('user'), $this->get('auth'), $this->get('log'), $this->get('dbal.conn'), $this->get('cache.driver'), './', 'php', 'phpbb_mchat', 'phpbb_mchat_sessions');
    }

    /**
     * Gets the 'dmzx.mchat.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \dmzx\mchat\event\listener A dmzx\mchat\event\listener instance.
     */
    protected function getDmzx_Mchat_ListenerService()
    {
        return $this->services['dmzx.mchat.listener'] = new \dmzx\mchat\event\listener($this->get('dmzx.mchat.functions_mchat'), $this->get('dmzx.mchat.core'), $this->get('controller.helper'), $this->get('user'), 'php');
    }

    /**
     * Gets the 'dmzx.mchat.main.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \dmzx\mchat\controller\main_controller A dmzx\mchat\controller\main_controller instance.
     */
    protected function getDmzx_Mchat_Main_ControllerService()
    {
        return $this->services['dmzx.mchat.main.controller'] = new \dmzx\mchat\controller\main_controller($this->get('dmzx.mchat.core'), $this->get('request'));
    }

    /**
     * Gets the 'dmzx.prettytopic.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \dmzx\prettytopic\event\listener A dmzx\prettytopic\event\listener instance.
     */
    protected function getDmzx_Prettytopic_ListenerService()
    {
        return $this->services['dmzx.prettytopic.listener'] = new \dmzx\prettytopic\event\listener();
    }
    ...
    /**
     * Gets the 'sitesplat.bbcore.admin_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \sitesplat\BBCore\event\admin_listener A sitesplat\BBCore\event\admin_listener instance.
     */
    ...
    /**
     * Gets the 'sitesplat.bbcore.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \sitesplat\BBCore\event\listener A sitesplat\BBCore\event\listener instance.
     */
    protected function getSitesplat_Bbcore_ListenerService()
    {
        return $this->services['sitesplat.bbcore.listener'] = new \sitesplat\BBCore\event\listener($this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('controller.helper'), $this->get('template'), $this);
    }

    /**
     * Gets the 'sitesplat.flatbootsminicms.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \sitesplat\flatbootsminicms\event\listener A sitesplat\flatbootsminicms\event\listener instance.
     */
    protected function getSitesplat_Flatbootsminicms_ListenerService()
    {
        return $this->services['sitesplat.flatbootsminicms.listener'] = new \sitesplat\flatbootsminicms\event\listener($this->get('dbal.conn'), $this->get('config'), $this->get('template'), $this->get('user'), './', 'phpbb_flatboots_style_menu', 'phpbb_flatboots_style_config', 'phpbb_flatboots_style_links', 'phpbb_flatboots_style_social');
    }

    /**
     * Gets the 'sitesplat.fltl.admin_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \sitesplat\fltl\event\admin_listener A sitesplat\fltl\event\admin_listener instance.
     */
    protected function getSitesplat_Fltl_AdminListenerService()
    {
        return $this->services['sitesplat.fltl.admin_listener'] = new \sitesplat\fltl\event\admin_listener($this->get('config'), $this->get('request'), $this->get('controller.helper'), $this->get('template'));
    }

    /**
     * Gets the 'sitesplat.fltl.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \sitesplat\fltl\event\listener A sitesplat\fltl\event\listener instance.
     */
    protected function getSitesplat_Fltl_ListenerService()
    {
        return $this->services['sitesplat.fltl.listener'] = new \sitesplat\fltl\event\listener($this->get('dbal.conn'), $this->get('auth'), $this->get('config'), $this->get('user'), $this->get('template'), $this, './', 'php');
    }

    /**
     * Gets the 'sitesplat.fltl.main' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \sitesplat\fltl\controller\main A sitesplat\fltl\controller\main instance.
     */
    protected function getSitesplat_Fltl_MainService()
    {
        return $this->services['sitesplat.fltl.main'] = new \sitesplat\fltl\controller\main($this->get('dbal.conn'), $this->get('auth'), $this->get('config'), $this->get('user'), $this->get('request'), './', 'php');
    }

    /**
     * Gets the 'sitesplat.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \sitesplat\service A sitesplat\service instance.
     */
    ...
    /**
     * Gets the 'sitesplat.snappy.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \sitesplat\snappy\event\listener A sitesplat\snappy\event\listener instance.
     */
    protected function getSitesplat_Snappy_ListenerService()
    {
        return $this->services['sitesplat.snappy.listener'] = new \sitesplat\snappy\event\listener($this->get('auth'), $this->get('config'), $this->get('user'), $this->get('template'), './', 'php', $this->get('plupload'), $this->get('cache'), $this->get('request'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dmzx.mchat.table.mchat' => 'phpbb_mchat',
            'dmzx.mchat.table.mchat_sessions' => 'phpbb_mchat_sessions',
            'sitesplat.flatbootsminicms.tables.flatboots_style_menu' => 'phpbb_flatboots_style_menu',
            'sitesplat.flatbootsminicms.tables.flatboots_style_config' => 'phpbb_flatboots_style_config',
            'sitesplat.flatbootsminicms.tables.flatboots_style_links' => 'phpbb_flatboots_style_links',
            'sitesplat.flatbootsminicms.tables.flatboots_style_social' => 'phpbb_flatboots_style_social',
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'phpbb_',
            'cache.driver.class' => 'phpbb\\cache\\driver\\file',
            'dbal.driver.class' => 'phpbb\\db\\driver\\mysqli',
            'dbal.dbhost' => 'localhost',
            'dbal.dbuser' => 'sanctuar_phpb337',
            'dbal.dbpasswd' => '4]wS[Pp23r',
            'dbal.dbname' => 'sanctuar_phpb337',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
